...
class FileChatMessageHistory(BaseChatMessageHistory):
    ...
    def messages(self) -> list[BaseMessage]:
        ...
        try:
            ...
            return []
                # messages_from_dict作用
                # [
                #     {"type": "human", "data": {"content": "小明有2个猫"}},
                #     {"type": "ai", "data": {"content": "好的"}}
                # ]
                # 变为
                # [
                #     HumanMessage(content="小明有2个猫"),
...
conversation_chain = RunnableWithMessageHistory(
    ...
    history_messages_key="chat_history"     # 表示历史消息输入在模板中的占位符
)
